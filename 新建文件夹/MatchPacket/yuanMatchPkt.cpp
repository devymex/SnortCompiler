...
//
//void FindSig(size_t sig, std::map<size_t, std::vector<SIGSID>> &hashtable, std::vector<size_t> &matchedSids)
//{
...
//				if (sig == iter->sig)
//				{
//					matchedSids.resize(matchedSids.size() + 1);
//					matchedSids.back() = iter->sig;
//				}
//			}
//		}
//	}
...
//			FindSig(HashFcn(onesig), hashtable, matchedSids);
